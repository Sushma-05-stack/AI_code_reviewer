...
export default function RegisterPage() {
  ...
  const fields = [
    { key: 'name', label: 'Full Name', type: 'text', icon: User, placeholder: 'John Doe', autoComplete: 'name' },
  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] flex items-center justify-center px-4 relative overflow-hidden py-12">
      ...
      >
        ...
        <div className="glass rounded-3xl p-8 border border-white/8">
          ...
          <p className="text-slate-400 text-sm mb-8">Start reviewing code with AI today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              className="w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
